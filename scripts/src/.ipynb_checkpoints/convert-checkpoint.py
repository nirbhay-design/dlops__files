...
def main():
    ...
    os.system(f'trtexec --onnx={ONNX_MODEL_PATH} --explicitBatch --workspace=4860 --optShapes=input:8x3x224x224 --maxShapes=input:128x3x224x224 --minShapes=input:1x3x224x224 --saveEngine={TRT_MODEL_PATH}')

    os.system(f'trtexec --onnx={ONNX_MODEL_PATH} --explicitBatch --workspace=4860 --optShapes=input:8x3x224x224 --maxShapes=input:128x3x224x224 --minShapes=input:1x3x224x224 --saveEngine={TRT_MODEL_PATH_FP16} --fp16')
